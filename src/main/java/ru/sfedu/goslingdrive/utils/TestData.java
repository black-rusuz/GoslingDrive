...
public class TestData {
    public static final BodyPart b1 = new BodyPart(11, "Bumper", 25000, "A1BX4", 6, "Red", "Front");
    public static final BodyPart b2 = new BodyPart(12, "Door", 15000, "BX12S", 24, "White", "Right back");
    ...
    public static final RunningPart r1 = new RunningPart(31, "Engine", 80000, "JLKJ2", 60, false);
    public static final RunningPart r2 = new RunningPart(32, "Gearbox", 25000, "OJHD5", 30, true);
